 ...
 * 
 * <p>
 * Copyright: Copyright (c) 2015年6月15日 下午3:19:08
 * <p>
 * Company:
 * <p>
 * @author Cherry
 * @version 1.0.0
 */
public class JettyQueuedThreadPool  extends AbstractLifeCycle implements SizedThreadPool, Executor, Dumpable{
	  private static final Logger LOG = Log.getLogger(JettyQueuedThreadPool.class);
	    ...
	    /** Construct
	     */
	    public JettyQueuedThreadPool(int maxThreads)
	    {
	        this();
	    ...
	    /** Construct
	     */
	    public JettyQueuedThreadPool(BlockingQueue<Runnable> jobQ)
	    {
	        this();
	        _jobs=jobQ;
	        _jobs.clear();
	    ...
	    protected void doStart() throws Exception
	    {
	        ...
	        if (_jobs==null)
	        {
	            _jobs=_maxQueued>0 ?new LinkedBlockingQueue<Runnable>(_maxQueued)
